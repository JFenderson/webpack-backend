...
var _Chirp = __webpack_require__(78);
...
var Chirp = function (_Component) {
    ...
    function Chirp() {
        ...
        var _this = _possibleConstructorReturn(this, (Chirp.__proto__ || Object.getPrototypeOf(Chirp)).call(this));
    ...
    _createClass(Chirp, [{
        key: 'fetchChirp',
        value: function fetchChirp() {
            var _this2 = this;

            var id = this.props.match.params.id;

            fetch('http://localhost:3000/api/chirps/' + id).then(function (res) {
                return res.json();
            }).then(function (chirp) {
                _this2.setState({
                    chirp: chirp
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Chirp2.default, { config: this.state.chirp, handleDelete: this.handleDelete }),
...
var _Chirp = __webpack_require__(47);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/chirp/:id', component: _Chirp2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/add', exact: true, component: _Add2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/edit/:id', exact: true, component: _Edit2.default })
                )
            );
        }
    }]);
...
var Home = function (_Component) {
    ...
    function Home(props) {
        ...
        _this.handleDelete = function (id) {
            fetch('http://localhost:3000/api/chirps/' + id, {
                ...
                var chirps = [].concat(_toConsumableArray(_this.state.chirps));
                var deleteIndex = chirps.findIndex(function (chirp) {
                    return chirp.id === id;
                });
    ...
    _createClass(Home, [{
        ...
        value: function render() {
            ...
            var mapChirps = this.state.chirps.map(function (chirp) {
                return _react2.default.createElement(_Chirp2.default, { key: chirp.id, config: chirp,
...
function Chirp(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/chirp/' + props.config.id },
            'SEE DETAILS'
        ),
        _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                    props.handleDelete(props.config.id);
                } },
            _react2.default.createElement(
                'i',
    ...
    function Add() {
        ...
        _this.handleSubmit = function () {
            ...
            fetch('http://localhost:3000/api/chirps', {
                ...
                _this.props.history.push('/chirp/' + response.id);
            });
        };
    ...
    _createClass(Add, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('textarea', { onChange: this.handleChange, name: '', id: '', cols: '30', rows: '10', placeholder: 'Write your chirp' }),
                _react2.default.createElement(
                    'button',
...
var Edit = function (_Component) {
    ...
    function Edit() {
        ...
        _this.handleSubmit = function () {
            var chirp = {
                handle: _this.state.chirp.handle,
                message: _this.state.chirp.message
            };

            fetch('http://localhost:3000/api/chirps/' + _this.state.chirp.id, {
                method: 'PUT',
                body: JSON.stringify(chirp),
                headers: new Headers({
                    'Accept': 'application/json',
                ...
                _this.props.history.push('/chirp/' + _this.state.chirp.id);
            });
        };

        _this.handleChange = function (e) {
            _this.setState({
                chirp: Object.assign({}, _this.state.chirp, { message: e.target.value })
            });
        };
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h1',
                    null,
                    'Jen wants to take back what she said:'
                ),
                _react2.default.createElement('textarea', { onChange: this.handleChange, name: '', id: '', cols: '30', rows: '10', placeholder: this.state.chirp.message }),
                _react2.default.createElement(
                    'button',
                    { onClick: this.handleSubmit },
                    'SUBMIT'
